...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!verify_csrf_token($csrfToken)) {
        ...
        if ($pdo) {
            $stmt = $pdo->prepare("SELECT id, username, password FROM profs WHERE username = :username");
...
?>
    ...
    <section class="connexion-section">
        <div class="form-container">
            ...
            <form action="connexionprofs.php" method="POST" class="login-form">
            ...
            <div class="form-footer">
                <p>Pas encore de compte ? <a href="inscriptionprofs.php">S'inscrire</a></p>
            </div>
        </div>
    </section>
