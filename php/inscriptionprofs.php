    ...
    if (!verify_csrf_token($csrfToken)) {
        ...
        if ($pdo) {
            ...
            if ($stmt->fetch()) {
                ...
                $stmt = $pdo->prepare("INSERT INTO profs (username, password, email) VALUES (:username, :password, :email)");
                $stmt->bindParam(':username', $username, PDO::PARAM_STR);
...
?>
    ...
    <section class="connexion-section">
        <div class="form-container">
            ...
            <form action="inscriptionprofs.php" method="POST" class="login-form">
            ...
            <div class="form-footer">
                <p>Déjà un compte ? <a href="connexionprofs.php">Se connecter</a></p>
            </div>
        </div>
    </section>
